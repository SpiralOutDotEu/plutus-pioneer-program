...
mkValidator _ (b, c) _ = traceIfFalse "Wrong Redeemer: Two booleans are not equal" $ b == c  -- FIXED!

data Typed
instance Scripts.ValidatorTypes Typed where
    type instance DatumType Typed = ()
    type instance RedeemerType Typed = (Bool, Bool) --FIXED!

typedValidator :: Scripts.TypedValidator Typed
-- typedValidator = undefined -- FIXED!
